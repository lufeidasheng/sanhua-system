...
TARGET_PREFIXES = ['"sysmon."', '"memory."', '"ai.ask"', '"system."', '"code_reader."']


def main():
    ap = argparse.ArgumentParser(description="稳健修复 decision chain 白名单，加入 code_reader. 前缀")
    ...
    print("=" * 72)
    print("decision chain whitelist v4 补丁完成")
    print("=" * 72)
