...
TARGET_PREFIX = '"code_executor.syntax_"'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="patch decision chain whitelist v6")
    ...
    if new == old:
        print("[SKIP] 白名单已包含 code_executor.syntax_")
        raise SystemExit(0)
    ...
    print("=" * 72)
    print("decision chain whitelist v6 补丁完成")
    print("=" * 72)
    print(f"[PATCHED] {target}")
    print("新白名单追加:")
    print("  - code_executor.syntax_")
    print("=" * 72)
